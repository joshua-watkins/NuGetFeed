...
public class V3UpstreamClient : IUpstreamClient
{
    ...
    private Package ToPackage(Models.PackageMetadata metadata)
    {
    ...
    private List<PackageDependency> ToDependencies(Models.PackageMetadata package)
    {
